<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adminlogin.aspx.cs" Inherits="WebApplication2.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        <div id="login">
            ...
            <br />
            <asp:Button ID="loginbutton" runat="server" Text="Login" OnClick="adminlogin"/>
            <br />
